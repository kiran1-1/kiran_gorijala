...
const Hero = () => {
  ...
  <a href="https://www.capitalone.com/">Capital One</a> {' '} since January 2024, where I focus on building scalable data pipelines and optimizing data workflows to drive actionable insights.
</p>
<p>
